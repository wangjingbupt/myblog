...
class ViewPhotos {
	...
	public function render($datas)
	{
		...
		if(is_array($datas['photos']) && !empty($datas['photos']))
		{
			...
			{
				 $html .= '<div class="item '.$active.'"><center><img  style="max-height:600px" src="'.Tools::formatImgUrl($photo['standard']).'" alt=""><div class="carousel-caption"><p>'.$photo['description'].'</p></div></center></div>';
					$active ='';
			}
