...
<script src="http://tjs.sjs.sinajs.cn/open/api/js/wb.js?appkey=4139435071" type="text/javascript" charset="utf-8"></script>
...
<a href="<?php echo $code_url?>"><wb:login-button type="3,2" onlogin="login" onlogout="logout">登录按钮</wb:login-button></a>
